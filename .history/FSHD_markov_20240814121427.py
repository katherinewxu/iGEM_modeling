...
observed_counts = np.array(list(observed_state_distribution_3days.values()))
expected_counts = np.array(list(expected_state_distribution.values()))
...
if p_value > 0.05:
    print("No significant difference between observed and expected distributions (p > 0.05)")
else:
    print("Significant difference between observed and expected distributions (p ≤ 0.05)")