    ...
    for _ in range(time_steps):
        ...
        for state, count in state_distribution.items():
            if count > 0 and state in transition_probabilities:
                ...
                # If no transitions are defined (e.g., for an absorbing state like 'D'), keep the count
...
simulation_history = simulate_markov_model(adjusted_transition_probabilities, initial_state_distribution, num_steps)
