...
observed_distribution = {"S": 4956, "E": 14, "I": 13, "R": 150, "D": 0}
predicted_distribution = {"S": 4900, "E": 20, "I": 10, "R": 160, "D": 0}

# Convert dictionaries to arrays
observed_counts = np.array(list(observed_distribution.values()))
predicted_counts = np.array(list(predicted_distribution.values()))
