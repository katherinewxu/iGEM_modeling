...
# Normalize predicted counts to match the sum of observed counts
total_observed = np.sum(observed_counts)
total_predicted = np.sum(predicted_counts)

if total_predicted > 0:
    predicted_counts = predicted_counts * (total_observed / total_predicted)
