...
# Now you can use transition_probabilities in the bayesian_optimization function
optimized_probabilities = bayesian_optimization(ransition_probabilities, initial_state_distribution, observed_state_distribution_3days)
